...
public final class BaseXClient {
    ...
    /**
     * Get a client with the database open
     * @return the database client
     * @throws IOException
     */
    public static BaseXClient getClient() throws IOException {
        BaseXClient client = new BaseXClient(ServerConfiguration.getConfigurationString("database", "host"),
    ...
    public Query query(final String query) throws IOException {
        return new Query(String.format("declare default element namespace \"%s\";", ServerConfiguration.getConfigurationString("database", "default-namespace")) + query);
    }
